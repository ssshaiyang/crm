...
export class SquareAppBlock extends React.Component {
    constructor(props) {
        super(props);
    }
...
function mapDispatchToProps(dispatch) {
    return {
        openAppDetailModel: () => dispatch(actionCreater.toShowSquareModal(true)),
        initAppDetailModel: (id, status) => dispatch(actionCreater.squareModalDetail(id, status))
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(SquareAppBlock)