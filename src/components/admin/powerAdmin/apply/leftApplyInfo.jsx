...
export class LeftApplyInfo extends React.Component {
                ...
                return (
                    <div>
                        <span id={item.role_id}>
                            <table>
                                <tr>
                                    <td style={{ width: 160,padding:'5px 0' }}><a onClick={this.showRoleApplyInfo.bind(this, item.role_id,item.role_name)}>{item.role_name}</a></td>
                                </tr>
                            </table>
                        </span>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(LeftApplyInfo))