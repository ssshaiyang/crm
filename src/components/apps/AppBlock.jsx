...
function mapDispatchToProps(dispatch) {
	return {
		openAppDetailModel: () => dispatch(actionCreater.switchAppDetailModelVisibleActionCreater(true)),
		initAppDetailModel: (id, status) => dispatch(actionCreater.initAppDetailModelActionCreater(id, status))
	}
}
