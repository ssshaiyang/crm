...
import * as actionCreater from '../../actions/apps/appDetailModel.js'
import DetailModelFontBlock from './DetailModelFontBlock.jsx'
...
function mapStateToProps(state) {
        return {
            visible: state.appDetailModel.visible,
            data: state.appDetailModel.data
        }
    }

    function mapDispatchToProps(dispatch) {
        return {
            closeModel: () => dispatch(actionCreater.switchAppDetailModelVisibleActionCreater(false)),
