...
function mapStateToProps(state) {
    return {
        topZhi: state.inFountData.inFountPaymentTop,
        detailData:state.inFountData.inFountPaymentCenter,
        people:state.inFountData.accountList,
        pay_manage_id:state.inFountData.pay_manage_id
    }
}
function mapDispatchToProps(dispatch) {
    return {
        getOutFountList:()=>dispatch(actionCreater.inFountList()),
        changePage:(page,limit)=>dispatch(actionCreater.inPageActionCreater(page,limit)),
        getData:()=>dispatch(actionCreater.inFountListGetPaymentAccount()),
