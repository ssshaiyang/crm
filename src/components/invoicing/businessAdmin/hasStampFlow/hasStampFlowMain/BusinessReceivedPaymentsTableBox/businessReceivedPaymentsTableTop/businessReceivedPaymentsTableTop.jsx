...
export class BusinessReceivedPaymentsTableTop extends React.Component {
    constructor(props) {
        super(props);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BusinessReceivedPaymentsTableTop)