...
import BusinessReceivedPaymentsTableBox from './businessReceivedPaymentsTableBox/businessReceivedPaymentsTableBox.jsx'
...
export class businessComponyReceivedPayments extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>过票流程-商业公司回款</div>
                ...
                <BusinessReceivedPaymentsTableBox />
            </div>
        )
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(businessComponyReceivedPayments))