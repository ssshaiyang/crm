...
import PutToStorageTableBox from './putToStorageTableBox/putToStorageTableBox.jsx'
...
export class BusinessPutToStorage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>过票流程-商业公司入库</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(BusinessPutToStorage))