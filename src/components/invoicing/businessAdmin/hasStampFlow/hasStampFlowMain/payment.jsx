...
import PaymentTableBox from './paymentTableBox/paymentTableBox.jsx'
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>过票过程--付款</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(Payment))