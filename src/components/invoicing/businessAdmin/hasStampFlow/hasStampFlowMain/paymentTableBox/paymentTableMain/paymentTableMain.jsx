...
import Arrearage from './arrearage.jsx'
...
export class PaymentTableMain extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(PaymentTableMain))