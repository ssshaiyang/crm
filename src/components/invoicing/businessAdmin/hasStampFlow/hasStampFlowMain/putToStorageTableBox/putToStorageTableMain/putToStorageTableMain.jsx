...
import AddPutStorageInfo from './addPutStorageInfo.jsx'
...
export class PurchaseTableMain extends React.Component {
    ...
    render() {
        ...
        const columns = [
            ...
            {
                title: '入库数量',
                dataIndex: 'put_storage',
                key: 'put_storage',
                width: 100
            },
            {
                title: '入库药品批号',
                dataIndex: 'put_storage_drug_id',
                key: 'put_storage_drug_id',
                width: 150
            },
            {
                title: '入库日期',
                dataIndex: 'put_storage_data',
                key: 'put_storage_data',
                width: 120
            },
            {
                title: '备注',
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(PurchaseTableMain))