...
import ReceivedPaymentsTableBox from './receivedPaymentsTableBox/receivedPaymentsTableBox.jsx'
...
export class ReceivedPayments extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>过票流程-回款</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(ReceivedPayments))