...
import TaxReceiptTableBox from './taxReceiptTableBox/taxReceiptTableBox.jsx'
...
export class TaxReceipt extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>过票流程-税票</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(TaxReceipt))