...
export class TaxReceiptCheckPending extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <span style={{ fontSize: 16, marginRight: 8, cursor: 'pointer' }} onClick={this.toCheck.bind(this)}><Icon type="edit" /></span>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(TaxReceiptCheckPending))