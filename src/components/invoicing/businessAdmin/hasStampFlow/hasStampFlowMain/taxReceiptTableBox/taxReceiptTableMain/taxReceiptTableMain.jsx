...
import AddTaxReceiptInvoiceCompanyInfo from './addTaxReceiptInvoiceCompanyInfo.jsx'
import TaxReceiptCheckPending from './taxReceiptCheckPending.jsx'
import CompleteInvoiceinfo from './completeInvoiceinfo.jsx'
import CompleteReceiptInfo from './completeReceiptInfo.jsx'
...
export class TaxReceiptTableMain extends React.Component {
    ...
    renderColumns(value, record) {
        if (record.letter_state == '未开票') {
            return (
                <AddTaxReceiptInvoiceCompanyInfo />
            );
        } else if (record.letter_state == '开票申请') {
            if (record.approval_status == '待审核') {
                return (
                    < TaxReceiptCheckPending />
                );
        ...
        } else if (record.letter_state == '补全发票信息') {
            if (record.approval_status == '待审核') {
                return (
                    < CompleteInvoiceinfo />
                );
        ...
        } else if (record.letter_state == '发票签收') {
            if (record.approval_status == '待审核') {
                return (
                    < CompleteReceiptInfo />
                );
    ...
    render() {
        ...
        },
        {
            ...
            filters: [
                { text: '未开票', value: '未开票' },
                { text: '开票申请', value: '开票申请' },
                { text: '补全发票信息', value: '补全发票信息' },
                { text: '发票签收', value: '发票签收' },
            ],
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(TaxReceiptTableMain))