...
import NoStampBusinessPutToStorageTableBox from './noStampBusinessPutToStorageTableBox/noStampBusinessPutToStorageTableBox.jsx'
...
export class NoStampBusinessPutToStorage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>不过票流程-商业公司入库</div>
                ...
                <NoStampBusinessPutToStorageTableBox />
            </div>
        )
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(NoStampBusinessPutToStorage))