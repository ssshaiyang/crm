...
export class NoStampBusinessPutToStorageTableTop extends React.Component {
    constructor(props) {
        super(props);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(NoStampBusinessPutToStorageTableTop)