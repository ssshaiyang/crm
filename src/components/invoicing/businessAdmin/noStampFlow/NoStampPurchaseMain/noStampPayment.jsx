...
import NoStampPaymentTableBox from './noStampPaymentTableBox/noStampPaymentTableBox.jsx'
...
export class NoStampPayment extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>不过票过程--付款</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(NoStampPayment))