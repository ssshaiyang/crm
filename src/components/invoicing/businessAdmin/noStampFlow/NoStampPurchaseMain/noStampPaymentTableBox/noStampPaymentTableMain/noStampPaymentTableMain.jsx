...
import Arrearage from '../../../../hasStampFlow/hasStampFlowMain/paymentTableBox/paymentTableMain/arrearage.jsx'
...
export class NoStampPaymentTableMain extends React.Component {
    ...
    renderColumns(value, record) {
        ...
        } else if (record.document_status == '未付款') {
            return (
                <Arrearage />
            );
        } else if (record.document_status == '已付款') {
            return (
                <CheckInfo />
            );
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(NoStampPaymentTableMain))