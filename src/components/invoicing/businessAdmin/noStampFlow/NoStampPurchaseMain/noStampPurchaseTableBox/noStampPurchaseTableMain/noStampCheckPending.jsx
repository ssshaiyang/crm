...
export class NoStampCheckPending extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            >
                                {getFieldDecorator('payment_type', {
                                    ...
                                    <RadioGroup onChange={this.onClickValue.bind(this)}>
                                        ...
                                        <Radio value={2}>商业公司预付</Radio>
                                        <Radio value={3}>固定期限回款</Radio>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(NoStampCheckPending))