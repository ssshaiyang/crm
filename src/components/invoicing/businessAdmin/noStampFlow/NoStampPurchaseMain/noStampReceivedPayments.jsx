...
import NoStampReceivedPaymentsTableBox from './noStampReceivedPaymentsTableBox/noStampReceivedPaymentsTableBox.jsx'
...
export class NoStampReceivedPayments extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <div className='purchase_top_container'>
                <div className='purchase_tip'>不过票流程-回款</div>
                ...
                <NoStampReceivedPaymentsTableBox />
            </div>
        )
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(NoStampReceivedPayments))