    ...
    render(){
        return (
            <div>
                ...
                >
                    <p style={{marginTop:"20px",textAlign:"center",fontSize:"14px"}}>正在对库存进行解冻操作，请确认！</p>
...
function mapStateToProps(state){
    return{
        visible:state.inventory.unfreezeVisible
    }
}
function mapDispatchToProps(dispatch){
    return{
        openModalBox:(val)=>dispatch(actionCreater.unfreezeActionCreater(val))
    }
}
